...
- [x] **SEO Utils Refactoring**: Improve SEO utility organization

  - [x] Split `seo-utils.ts` into focused modules:
    - [x] `src/utils/seo/metadata-generators.ts`
    - [x] `src/utils/seo/structured-data.ts`
    - [x] `src/utils/seo/keywords.ts`
  - [x] Implement MetadataGenerator class for centralized logic
  - [x] Create StructuredDataFactory for reusable patterns
  - [x] Remove repetitive type guards and consolidate logic

- [x] **Content Optimization**: Improve data fetching efficiency
  - [x] Reduce duplicate `getAllCourseLessons()` calls
  - [x] Optimize sorting operations
  - [x] Add content preloading strategies
