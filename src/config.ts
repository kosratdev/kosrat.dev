...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// {
		// 	name: "GitHub",
		// 	url: "https://github.com/kosratdev", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		// `pnpm add @iconify-json/<icon-set-name>`
		{
			...
			url: "https://github.com/kosratdev",
		},
		{
			name: "LinkedIn",
			icon: "fa6-brands:linkedin",
			url: "https://linkedin.com/in/kosratahmad",
		},
		{
			name: "Email",
